class Libkrun < Formula
  ...
  url "https://github.com/containers/libkrun/releases/download/v1.2.3/v1.2.3-with_macos_prebuilts.tar.gz"
  sha256 "e8eb526ec9c568677219e6eaeae74bd2ad4ea31569231d0e777ec1f0e3a7b89b"
  license "Apache-2.0"
